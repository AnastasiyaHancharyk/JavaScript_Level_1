...
// default является необязательным блоком, который срабатывает тогда, когда ни один case не подошёл (т.е. в предыдущем случае отобразтлось бы сообщение ""Unkwown").
