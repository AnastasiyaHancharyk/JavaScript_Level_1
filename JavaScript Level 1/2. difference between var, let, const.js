// ОСОБЕННОСТИ VAR: 
// 1. Является наиболее ранним способом объявления переменных (появился в 1995 году), благодаря чему может быть использован при необходимости поддержки более ранних версий браузеров;
...
console.log(city);  // В консоль будет выведено значение "Tokyo"
...
// 2. В отличие от var и let, значение для самой переменной должно быть определено сразу. Например:
