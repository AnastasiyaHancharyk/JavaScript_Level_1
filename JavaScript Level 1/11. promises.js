...
// then — запускает колбек, который был передан, когда промис завершен.
// catch — запускает колбек, который был передан, когда что-то идет не так, что вызывает reject вместо resolve.